package com.revision.classexercise.java17lambda.exercise34.src;
...
class Exercise34 {
    public static void main(String args[]) {
        ...
        // Using lambda expression to invoke forEach() method to print all elements in
        // ArrayList integers
        ...
        // For example, [2, 3, 4] -> [2, 3, 4, 3, 5], because 2 and 4 are even numbers,
        // 3=2+1, 5=4+1.
