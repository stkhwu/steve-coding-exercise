package com.revision.classexercise.java12polymorphism.exercise24.src;
/**
 * do something
 * do something else
...
public class Exercise24 {
    ...
    public void doSomething(int times) {
        System.out.println("do something " + times + " times");
    }

    public void doSomething(String something, int times) {
        System.out.println("do "+ something + " "+ times + " times");
    }
