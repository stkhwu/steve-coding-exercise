...
import com.homework.ex1.SortHeight;
import com.homework.ex3.StockMax;
...
//        System.out.println(LinkedList.findSize(aNode));
        ...
        String[] ppls = {"Mary", "John", "Emma"};
        int[] heights = {180, 165, 170};
        System.out.println(Arrays.toString(SortHeight.getTallest(ppls, heights)));

        System.out.println(StockMax.findMaxProfit(new int[]{7, 1, 5, 3, 6, 4}));
    }
}
